...
class AppColors {
  ...
  static Gradient get gradintBluePurpel => LinearGradient(
        ...
        colors: [
          AppColors.bluePurpelGradiantOne,
          AppColors.bluePurpelGradiantTwo
        ],
      );
...
//Done
  ...
  static Color get greyColor => const Color.fromRGBO(31, 32, 38, 1);
  static Color get greyColor1 => const Color.fromRGBO(32, 33, 39, 1);
  static Color get greyColor2 => const Color.fromRGBO(36, 37, 42, 1);
  static Color get black => Colors.black;
  static Color get greenColor1 => const Color.fromRGBO(0, 255, 51, 1);
  static Color get greenColor2 => const Color.fromRGBO(29, 165, 56, 1);
  static Color get darkblackgreen => const Color.fromRGBO(3, 91, 21, 1);
  static Color get gradient1 => const Color.fromRGBO(218, 218, 218, 1);
  static Color get gradient2 => const Color.fromRGBO(3, 3, 3, 1);
  static Color get greenBlack => const Color(0xFF2E5536);
  static Color get lightWhite => const Color(0xFF979797);
  static Color get green => const Color(0xFF10FF40);
  static Color get lightBlackGreen => const Color(0xFF29763A);
  static Color get blackish => const Color(0xFF212428);
  static Color get whiteBLack => const Color(0xFFC2C2C2);

  static Color get lightBlue => const Color(0xFF00E0FF);
  static Color get lightDarkBlue => const Color(0xFF02A8A8);

  static Color get yellow => const Color(0xFFFAFF00);
  static Color get lightBlackYellow => const Color(0xFFE8ED00);

  static Color get red => const Color(0xFFFF0707);
  static Color get darkred => const Color(0xFF720000);
}
