...
import 'package:energym/utils/custom_timer_painter.dart';
...
class CircularCountDownTimer extends StatefulWidget {
  ...
  /// Text Style for Countdown Sub Text.
...
class CircularCountDownTimerState extends State<CircularCountDownTimer>
  ...
  String get time {
    if (widget.isReverse! && _controller!.isDismissed) {
      if (widget.textFormat == CountdownTextFormat.mmSS) {
        return '00:00';
  ...
  String _getTime(Duration duration) {
    // For HH:mm:ss format
    if (widget.textFormat == CountdownTextFormat.hhMMSS) {
      return '${duration.inHours.toString().padLeft(2, '0')}:${(duration.inMinutes % 60).toString().padLeft(2, '0')}:${(duration.inSeconds % 60).toString().padLeft(2, '0')}';
    }
    // For mm:ss format
    else if (widget.textFormat == CountdownTextFormat.mmSS) {
...
class CountdownTextFormat {
  ...
  static const String mmSS = 'mm:ss';
